...
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
               ...
               <div class="card-body">
               <a href="" class="btn btn-primary"data-bs-toggle="modal" data-bs-target="#tambahData">tambah data petugas</a>
               ...
               <div class="modal fade" id="tambahData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="kirim" class="btn btn-danger">Tambah Data</button>
                            </div>
                            </form>
                    ...
                    <table class="table table-striped">
                        ...
                        <div class="modal-dialog"> 
                            ...
                            <p>apakah anda yakin akan menghapus data <br><?php  echo $data['nama_petugas'] ?></p>
                                <div class="modal-footer">
                                <button type="submit" name="hapus_petugas" class="btn btn-primary">HAPUS</button>
                            </div>
                            </form>
